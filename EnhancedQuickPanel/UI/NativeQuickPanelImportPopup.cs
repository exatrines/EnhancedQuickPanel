...
/// <summary>Popup for importing slots from the game's native quick panel into a new page.</summary>
internal static class NativeQuickPanelImportPopup
{
    ...
    public static void Draw()
    {
        ...
        if (!ImGui.Begin(T("nativeImportWindow.title") + "##eqpNativeImportPopup", ref _isOpen, WindowFlags))
        {
            ImGui.End();
            return;
        }
    ...
    private static void DrawContent()
    {
        ...
        MirageUi.Text(T("nativeImportWindow.topLeftHint"), MirageUi.Color.Secondary);
    ...
    private static void ImportSelectedPage()
    {
        ...
        {
            Notifications.Warning(T("contextMenu.importNativeFailed"));
            return;
        }

        Config.Save();
        Notifications.Success(T("contextMenu.importNativeSuccess", _selectedNativePageIndex + 1));
    ...
    private static Vector2 ComputeWindowSize()
    {
        ...
        var controlsH = ImGui.GetFrameHeightWithSpacing() * 5.5f + style.ItemSpacing.Y * 3f;
